    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text(
              "To disable automasking in this screen change enableAutomaticMasking in the ScreenWidget constructor to true. All manual masking will still work."),
          const Text(
              "To disable the recording of popups that are launched from this screen, change enableAutomaticPopupRecording in the ScreenWidget constructor to false. Any popup (showDialog, Dropdowns, TimePickers...) will not be recorded.")
        ]
            .map((e) => Padding(
